    ...
    <g id="Klubbnettside-Logo_Hvit_v1" transform="translate(-1380 -33)">
      <g id="Group_67" transform="translate(-3058.274 -5334.416)">
        <g id="Group_1" transform="translate(4438.274 5509.416)">
          ...
          <path d="M384.5,133.076V136.8h-8.578v4.878h6.571v3.585h-6.571v4.977H384.5v3.73H371.041v-20.9Z" transform="translate(-124.497 -132.846)" fill="#fff"/>
        </g>
        <g id="Group_60" transform="translate(0 -1.689)">
      ...
      <g id="Group_70" transform="translate(584.689 -22.332)">
        <path d="M317.493,50.937c.012.154.023.31.023.468a5.259,5.259,0,1,1-8.465-4.162l0,0-5.027-3.022L299,47.238v0a5.256,5.256,0,1,1-8.463,4.162c0-.157.009-.313.023-.468L285.6,55.9l5.359,5.359h26.135l5.359-5.359Z" transform="translate(621.286 11.116)" fill="#fff"/>
        <path d="M334.848,58.089H289.291l-18.1,18.033v32.054s.173,30.166,40.874,48.294h0c40.7-18.128,40.874-48.294,40.874-48.294V76.122Zm13.261,50.061c0,.266-.567,26.3-36.04,43.019-35.473-16.723-36.04-42.753-36.041-43.019V78.118l15.266-15.21h41.551l15.264,15.21Z" transform="translate(613.242 18.862)" fill="#fff"/>
        <g id="Group_63" transform="translate(909.965 99.453)">
          <path d="M296.876,88.888h1.487a3.375,3.375,0,0,0,2.972-1.293l9.026-13.1a3.874,3.874,0,0,1,1.692-1.457,6.191,6.191,0,0,1,2.325-.386h8.091L310.582,88.86a8.012,8.012,0,0,1-1.322,1.459,8.4,8.4,0,0,1-1.4.963,7.117,7.117,0,0,1,1.912,1.06,7.028,7.028,0,0,1,1.583,1.8l12.108,18.6h-8.311a7.226,7.226,0,0,1-1.362-.111,3.423,3.423,0,0,1-.977-.33,2.754,2.754,0,0,1-.715-.536,5.437,5.437,0,0,1-.58-.729l-9.079-13.952A2.736,2.736,0,0,0,301.183,96a5.408,5.408,0,0,0-2.049-.316h-2.258v17.061h-9.3V72.652h9.3Z" transform="translate(-287.576 -72.652)" fill="#fff"/>
        </g>
      </g>
    </g>
  </svg>
  ...
  return (
    <div className="flex flex-col min-h-screen bg-white dark:bg-brand-dark transition-colors duration-300">
      ...
      <main className="flex-grow">
        ...
        {/* Why Choose Us - Now with requested Vertical Logo */}
        <section className="py-32 bg-gray-50 dark:bg-[var(--color-dark)] relative overflow-hidden transition-colors duration-300">
          <div className="container mx-auto px-6 grid lg:grid-cols-2 gap-24 items-center relative z-10">
            <div>
              ...
              <h2 className="text-6xl font-black mb-10 leading-none tracking-tighter dark:text-white uppercase">
                ...
                <br/>
                <span style={{ color: 'var(--color-accent)' }}>KLUBBDRYFT</span>
              </h2>
              <p className="text-gray-600 dark:text-gray-300 text-lg leading-relaxed mb-8">
                Vi er selv involvert i klubbarbeid, og vet oss lei av rotete kommunikasjon. Vi bygget systemet vi selv savnet – enkelt, kraftfullt og profesjonelt.
              </p>
            ...
            <div className="flex justify-center items-center">
              <div className="relative group">
                <div className="relative z-10 bg-brand-blue/90 dark:bg-brand-blue/30 p-12 rounded-[4rem] backdrop-blur-xl border border-white/10 shadow-3xl transform rotate-1 group-hover:rotate-0 transition-transform duration-700">
                  <VerticalLogo />
                </div>
                {/* Decorative brand glow */}
                <div className="absolute -inset-20 bg-brand-red/10 blur-[120px] -z-10 group-hover:bg-brand-red/20 transition-colors"></div>
              </div>
            </div>
          </div>
        </section>
        ...
        >
           <div className="container mx-auto px-6 text-center relative z-10">
              <h2 className="text-6xl font-black mb-16 uppercase tracking-tighter text-white">HAR DU NOE PÅ HJERTET?</h2>
              <div className="flex flex-col md:flex-row justify-center gap-10 text-2xl">
                 <div className="flex flex-col items-center">
                    <span className="text-gray-400 text-xs font-black uppercase tracking-[0.3em] mb-2">Ring oss</span>
                    <p className="text-white font-black transition-colors hover:text-[var(--color-accent)]">40 00 67 60</p>
                 </div>
                 <div className="w-px h-16 bg-white/10 hidden md:block"></div>
                 <div className="flex flex-col items-center">
                    <span className="text-gray-400 text-xs font-black uppercase tracking-[0.3em] mb-2">Send e-post</span>
                    <p className="text-white font-black transition-colors hover:text-[var(--color-accent)]">hei@klubbnettside.no</p>
                 </div>
              </div>
              ...
              <div className="mt-32 pt-16 border-t border-white/5 flex flex-col md:flex-row items-center justify-between gap-12">
                 <div className="flex items-center gap-4 group cursor-pointer">
                   ...
                   {footerLogo ? (
                     ...
                     <svg xmlns="http://www.w3.org/2000/svg" width="349" height="94" viewBox="0 0 349 94" className="h-10 w-auto">
                       <g id="Klubbnettside-Logo_Hvit_v2" transform="translate(-697 -269)">
                         <g id="Group_55" data-name="Group 55" transform="translate(-3652.274 -5213.86)">
                           <g id="Group_1" data-name="Group 1" transform="translate(4438.274 5509.86)">
                             ...
                             <path id="Path_40" data-name="Path 40" d="M234.138,150.1h7.745v3.873H229.29v-20.9h4.848Z" transform="translate(-205.937 -132.846)" fill="#fff"/>
                             ...
                             <path id="Path_45" data-name="Path 45" d="M312.219,133.076V136.8h-8.581v4.878h6.572v3.585h-6.572v4.977h8.581v3.73H298.763v-20.9Z" transform="translate(-166.023 -132.846)" fill="#fff"/>
                             <path id="Path_46" data-name="Path 46" d="M326.578,133.076v3.843H320.7v17.055h-4.848V136.919h-5.879v-3.843Z" transform="translate(-159.585 -132.846)" fill="#fff"/>
                             <path id="Path_47" data-name="Path 47" d="M339.314,133.076v3.843h-5.881v17.055h-4.85V136.919H322.7v-3.843Z" transform="translate(-152.268 -132.846)" fill="#fff"/>
                             <path id="Path_48" data-name="Path 48" d="M348.551,137.4a1.817,1.817,0,0,1-.45.516,1.017,1.017,0,0,1-.611.172,1.493,1.493,0,0,1-.71-.206l-.86-.468a7.225,7.225,0,0,0-1.1-.466,4.4,4.4,0,0,0-1.406-.208,3.023,3.023,0,0,0-2.03.581,1.976,1.976,0,0,0-.668,1.571,1.45,1.45,0,0,0,.4,1.047,3.46,3.46,0,0,0,1.055.716,11.133,11.133,0,0,0,1.493.553q.838.25,1.713.559a15.518,15.518,0,0,1,1.715.724,5.758,5.758,0,0,1,1.493,1.063,4.916,4.916,0,0,1,1.052,1.57,5.588,5.588,0,0,1,.4,2.231,7.248,7.248,0,0,1-.5,2.71,6.353,6.353,0,0,1-1.456,2.2,6.734,6.734,0,0,1-2.352,1.477,8.793,8.793,0,0,1-3.177.538,10.162,10.162,0,0,1-1.985-.2,11.559,11.559,0,0,1-1.957-.567,11.14,11.14,0,0,1-1.779-.866,7.553,7.553,0,0,1-1.449-1.12l1.433-2.267a1.172,1.172,0,0,1,.446-.416,1.271,1.271,0,0,1,.617-.157,1.645,1.645,0,0,1,.868.272q.437.272.989.6a8.077,8.077,0,0,0,1.269.6,4.74,4.74,0,0,0,1.693.272,3.233,3.233,0,0,0,2.052-.579,2.215,2.215,0,0,0,.732-1.844,1.74,1.74,0,0,0-.4-1.19,3.084,3.084,0,0,0-1.055-.761,9.638,9.638,0,0,0-1.483-.531q-.834-.229-1.707-.51a12.378,12.378,0,0,1-1.708-.688,5.42,5.42,0,0,1-1.485-1.075,5.055,5.055,0,0,1-1.055-1.664,6.61,6.61,0,0,1-.4-2.459,5.846,5.846,0,0,1,.472-2.3,5.921,5.921,0,0,1,1.392-1.993,6.81,6.81,0,0,1,2.252-1.4,8.309,8.309,0,0,1,3.055-.524,11.621,11.621,0,0,1,1.874.15,9.953,9.953,0,0,1,1.727.446,9.678,9.678,0,0,1,1.527.7,7.223,7.223,0,0,1,1.271.926Z" transform="translate(-144.982 -132.93)" fill="#fff"/>
                             <path id="Path_49" data-name="Path 49" d="M353.2,153.975H348.32v-20.9H353.2Z" transform="translate(-137.551 -132.846)" fill="#fff"/>
                             ...
                             <path id="Path_51" data-name="Path 51" d="M384.5,133.076V136.8h-8.578v4.878h6.571v3.585h-6.571v4.977H384.5v3.73H371.041v-20.9Z" transform="translate(-124.497 -132.846)" fill="#fff"/>
                           </g>
                           <g id="Group_60" data-name="Group 60" transform="translate(0 -1.245)">
                             ...
                             <rect id="Rectangle_45" data-name="Rectangle 45" width="17" height="8" transform="translate(4536.274 5543.105)" fill="#fff"/>
                             <rect id="Rectangle_46" data-name="Rectangle 46" width="17" height="8" transform="translate(4583.274 5543.105)" fill="#fff"/>
                         ...
                         <g id="Group_66" data-name="Group 66" transform="translate(-0.07 2.112)">
                           <path id="Path_263" data-name="Path 263" d="M310.569,49.478c.01.121.018.243.018.366a4.117,4.117,0,1,1-6.627-3.259v0l-3.936-2.366-3.935,2.366v0a4.115,4.115,0,1,1-6.626,3.259c0-.123.007-.245.018-.366L285.6,53.361l4.2,4.2h20.461l4.2-4.2Z" transform="translate(429.046 222.672)" fill="#fff"/>
                           <path id="Path_264" data-name="Path 264" d="M321.027,58.089H285.362L271.194,72.217V97.329s.135,23.633,32,37.835h0c31.864-14.2,32-37.835,32-37.835V72.217Zm10.382,39.22c0,.208-.444,20.6-28.215,33.7-27.771-13.1-28.215-33.494-28.216-33.7V73.78L286.93,61.864h32.53L331.41,73.78Z" transform="translate(425.876 225.724)" fill="#fff"/>
                           <g id="Group_65" data-name="Group 65" transform="translate(717.057 301.46)">
                             <path id="Path_52" data-name="Path 52" d="M295.006,85.624h1.188a2.7,2.7,0,0,0,2.374-1.033l7.211-10.466a3.1,3.1,0,0,1,1.352-1.164,4.946,4.946,0,0,1,1.858-.309h6.464l-9.5,12.949a6.4,6.4,0,0,1-1.056,1.165,6.714,6.714,0,0,1-1.122.769,5.686,5.686,0,0,1,1.528.847,5.613,5.613,0,0,1,1.265,1.44l9.674,14.862h-6.64a5.774,5.774,0,0,1-1.088-.088,2.735,2.735,0,0,1-.781-.264,2.2,2.2,0,0,1-.572-.428,4.349,4.349,0,0,1-.463-.583l-7.254-11.147a2.186,2.186,0,0,0-1-.868,4.321,4.321,0,0,0-1.637-.253h-1.8v13.631h-7.43V72.652h7.43Z" transform="translate(-287.576 -72.652)" fill="#fff"/>
                           </g>
                         </g>
                       </g>
                     </svg>
                 ...
                 <div className="flex flex-wrap justify-center gap-10 text-[10px] font-black text-gray-400 uppercase tracking-[0.2em]">
                    <a href="#" className="hover:text-white transition-colors">Hjem</a>
                    <a href="#" className="hover:text-white transition-colors">Funksjoner</a>
                    <a href="#" className="hover:text-white transition-colors">Support</a>
                    <a href="#" className="hover:text-white transition-colors">Book Demo</a>
