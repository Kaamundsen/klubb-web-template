...
// Hjelpefunksjon: sjekk om en farge er lys (for å velge riktig logo-variant)
      ...
      <g transform="translate(-697 -269)">
        <g transform="translate(-3652.274 -5213.86)">
          <g transform="translate(4438.274 5509.86)">
            ...
            <path d="M384.5,133.076V136.8h-8.578v4.878h6.571v3.585h-6.571v4.977H384.5v3.73H371.041v-20.9Z" transform="translate(-124.497 -132.846)" fill={fill}/>
          </g>
          <g transform="translate(0 -1.245)">
            ...
            <rect width="17" height="8" transform="translate(4536.274 5543.105)" fill={flagWhite}/>
            <rect width="17" height="8" transform="translate(4583.274 5543.105)" fill={flagWhite}/>
            <rect width="30" height="8" transform="translate(4553.274 5543.105)" fill={flagNavy}/>
          </g>
        </g>
        <g transform="translate(-0.07 2.112)">
          <path d="M310.569,49.478c.01.121.018.243.018.366a4.117,4.117,0,1,1-6.627-3.259v0l-3.936-2.366-3.935,2.366v0a4.115,4.115,0,1,1-6.626,3.259c0-.123.007-.245.018-.366L285.6,53.361l4.2,4.2h20.461l4.2-4.2Z" transform="translate(429.046 222.672)" fill={fill}/>
          <path d="M321.027,58.089H285.362L271.194,72.217V97.329s.135,23.633,32,37.835h0c31.864-14.2,32-37.835,32-37.835V72.217Zm10.382,39.22c0,.208-.444,20.6-28.215,33.7-27.771-13.1-28.215-33.494-28.216-33.7V73.78L286.93,61.864h32.53L331.41,73.78Z" transform="translate(425.876 225.724)" fill={fill}/>
          <g transform="translate(717.057 301.46)">
            <path d="M295.006,85.624h1.188a2.7,2.7,0,0,0,2.374-1.033l7.211-10.466a3.1,3.1,0,0,1,1.352-1.164,4.946,4.946,0,0,1,1.858-.309h6.464l-9.5,12.949a6.4,6.4,0,0,1-1.056,1.165,6.714,6.714,0,0,1-1.122.769,5.686,5.686,0,0,1,1.528.847,5.613,5.613,0,0,1,1.265,1.44l9.674,14.862h-6.64a5.774,5.774,0,0,1-1.088-.088,2.735,2.735,0,0,1-.781-.264,2.2,2.2,0,0,1-.572-.428,4.349,4.349,0,0,1-.463-.583l-7.254-11.147a2.186,2.186,0,0,0-1-.868,4.321,4.321,0,0,0-1.637-.253h-1.8v13.631h-7.43V72.652h7.43Z" transform="translate(-287.576 -72.652)" fill={fill}/>
          </g>
        </g>
      </g>
    </svg>
...
const App: React.FC = () => {
  ...
  // Footer bakgrunnsfarge
  const footerBg = isDarkMode 
    ? (styleSettings.footerBackgroundDark || 'var(--color-primary)')
    : (styleSettings.footerBackgroundLight || 'var(--color-primary)');
  
  // Sjekk om footer-bakgrunnen er lys → bruk mørk logo-variant
  const footerBgIsLight = isLightColor(
    isDarkMode ? (styleSettings.footerBackgroundDark || '') : (styleSettings.footerBackgroundLight || '')
  );
  ...
  // Ved lys footer-bakgrunn: bruk lys logo-variant (logoHorizontalLight) om tilgjengelig
  const footerLogo = (() => {
    if (isUploadedHorizontalLogo) {
      return footerBgIsLight 
        ? (styleSettings.logoHorizontalLight || styleSettings.logoHorizontal) 
        : styleSettings.logoHorizontal;
    }
    if (club.id !== 'master' && club.logos?.horizontal) {
      return club.logos.horizontal;
    }
    return null;
  })();
