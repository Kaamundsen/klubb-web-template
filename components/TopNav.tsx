        ...
        <div className="container mx-auto px-6 flex items-center justify-between">
          ...
          <div className="hidden lg:flex flex-shrink-0 items-center gap-5">
            ...
            <button 
              ...
              style={{ 
                background: `linear-gradient(135deg, var(--color-${styleSettings.ctaButtonColor}) 0%, ${styleSettings.ctaGradientColor === 'auto' ? `var(--color-${styleSettings.ctaButtonColor}-light)` : `var(--color-${styleSettings.ctaGradientColor})`} 100%)`,
