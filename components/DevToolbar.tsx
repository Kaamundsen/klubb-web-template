...
const DevToolbar: React.FC = () => {
  const {
    ...
    saveSettings, loadSettings, exportSettings, resetToClubDefaults,
        ...
        {activeTab === 'klubb' && (
          <div className="flex items-center gap-3 flex-wrap">
            ...
            <div className="flex items-center gap-1 bg-white/5 rounded px-2 py-1">
              ...
              <button
                onClick={() => {
                  if (confirm('Tilbakestill alle innstillinger til klubbens standard?')) {
                    resetToClubDefaults();
                  }
                }}
                className="flex items-center gap-1 px-2 py-1 bg-orange-600 hover:bg-orange-500 text-white rounded text-[9px] font-medium transition-all"
                title="Tilbakestill til klubbens standardinnstillinger"
              >
                {Icons.reset}
                <span>Reset</span>
              </button>
